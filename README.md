...
- 管理者権限を常用しない運用モデルの検証
- IAM と AWS Organizations（SCP）の優先関係の確認
...
## 学び
- Permission Set はユーザーと分離して権限を管理できる
- 同一ユーザーでもロール切り替えにより操作可否が変化する
- IAM で許可されていても SCP により拒否されるケースが存在する
